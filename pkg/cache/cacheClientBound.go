...
func (c *CacheClientBoundImpl) IntentDelete(ctx context.Context, intentName string, IgnoreNonExisting bool) error {
	return c.cacheClient.InstanceIntentDelete(ctx, c.cacheName, intentName, IgnoreNonExisting)
}

...
func (m *MockEntry) Identity() api.NodeIdentity {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Identity")
	ret0, _ := ret[0].(api.NodeIdentity)
	return ret0
}

// Identity indicates an expected call of Identity.
func (mr *MockEntryMockRecorder) Identity() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Identity", reflect.TypeOf((*MockEntry)(nil).Identity))
}

...
func (m *MockIntentReader) InstanceIntentGet(ctx context.Context, cacheName, intentName string) (importer.IntentAdapter, error) {
	m.ctrl.T.Helper()
...
func (m *MockIntentReader) InstanceIntentGetAll(ctx context.Context, cacheName string, excludeIntentNames []string, intentChan chan<- importer.IntentAdapter, errChan chan<- error) {
	m.ctrl.T.Helper()
...
// InstanceIntentGet mocks base method.
func (m *MockClient) InstanceIntentGet(ctx context.Context, cacheName, intentName string) (importer.IntentAdapter, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "InstanceIntentGet", ctx, cacheName, intentName)
	ret0, _ := ret[0].(importer.IntentAdapter)
	ret1, _ := ret[1].(error)
...
// InstanceIntentGetAll mocks base method.
func (m *MockClient) InstanceIntentGetAll(ctx context.Context, cacheName string, excludeIntentNames []string, intentChan chan<- importer.IntentAdapter, errChan chan<- error) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "InstanceIntentGetAll", ctx, cacheName, excludeIntentNames, intentChan, errChan)
}

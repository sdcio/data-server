...
func (m *MockBoundIntentReader) IntentGet(ctx context.Context, intentName string) (importer.IntentAdapter, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "IntentGet", ctx, intentName)
	ret0, _ := ret[0].(importer.IntentAdapter)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockBoundIntentReader) IntentGetAll(ctx context.Context, excludeIntentNames []string, intentChan chan<- importer.IntentAdapter, errChan chan<- error) {
	m.ctrl.T.Helper()
...
// IntentGet mocks base method.
func (m *MockCacheClientBound) IntentGet(ctx context.Context, intentName string) (importer.IntentAdapter, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "IntentGet", ctx, intentName)
	ret0, _ := ret[0].(importer.IntentAdapter)
	ret1, _ := ret[1].(error)
...
// IntentGetAll mocks base method.
func (m *MockCacheClientBound) IntentGetAll(ctx context.Context, excludeIntentNames []string, intentChan chan<- importer.IntentAdapter, errChan chan<- error) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "IntentGetAll", ctx, excludeIntentNames, intentChan, errChan)
}
